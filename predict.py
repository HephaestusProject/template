...
Options:    
    ...
    --weight_filepath <weight_filepath>  Path to *.pth file for model weights  [default: pretrained_weights/LeNet_epoch=01-train_loss=1.75-val_loss=1.59-train_acc=0.72-val_acc=0.88.ckpt] [type: path]
...
def predict(hparams: Dict):
    ...
    predictor = Predictor(model_conf=config.model, weight_filepath=weight_filepath)
